...
public class TerrainShader extends ShaderProgram{
	...
	private static final String vertexShaderFile = "src/dev/engine/terrains/terrainVertexShader.vs";
	private static final String fragmentShaderFile = "src/dev/engine/terrains/terrainFragmentShader.fs";
