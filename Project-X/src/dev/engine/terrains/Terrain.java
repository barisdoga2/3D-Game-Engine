...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, TerrainTexturePack terrainTexturePack, TerrainTexture blendMapTexture, String heightMapFile) {
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
		this.terrainTexturePack = terrainTexturePack;
		this.blendMapTexture = blendMapTexture;
		
		this.rawModel = generateTerrain(heightMapFile);
	}
