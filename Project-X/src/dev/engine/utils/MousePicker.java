...
public class MousePicker {
	...
	private Terrain mouseOnTerrain;
	...
	public Terrain getMouseOnTerrain(){
		return mouseOnTerrain;
	}
	...
	private Terrain getTerrain(float worldX, float worldZ) {
		for(Terrain terrain : terrains){
			if(terrain.getX() < worldX && terrain.getX() + Terrain.SIZE > worldX)
				if(terrain.getZ() < worldZ && terrain.getZ() + Terrain.SIZE > worldZ){
					mouseOnTerrain = terrain;
					break;
				}
		}
		return mouseOnTerrain;
